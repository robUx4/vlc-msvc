...
WIDL="wmidl" CONFIG_SITE=/dev/null USE_FFMPEG=1 WANT_AUTOMAKE=latest WANT_AUTOCONF=latest PKG_CONFIG_PATH="" CC_FOR_BUILD="gcc -std=c99" make -j$(expr $(nproc) - 1)|| exit 1
