...
@set VS_TARGET_ARM64=amd64_arm64
@IF "%CMAKE_SYSTEM_PROCESSOR%"=="ARM" @echo call %VSVARS% %VS_TARGET_ARM% %RUNTIME_VER17% %SDK_VER% -vcvars_ver=14.11.25503
@IF "%CMAKE_SYSTEM_PROCESSOR%"=="ARM" call %VSVARS% %VS_TARGET_ARM% %RUNTIME_VER17% %SDK_VER% -vcvars_ver=14.11.25503

@IF "%CMAKE_SYSTEM_PROCESSOR%"=="x86" @echo call %VSVARS% %VS_TARGET_x86% %RUNTIME_VER17% %SDK_VER% -vcvars_ver=14.11.25503
@IF "%CMAKE_SYSTEM_PROCESSOR%"=="x86" call %VSVARS% %VS_TARGET_x86% %RUNTIME_VER17% %SDK_VER% -vcvars_ver=14.11.25503

@IF "%CMAKE_SYSTEM_PROCESSOR%"=="amd64" @echo call %VSVARS% %VS_TARGET_AMD64% %RUNTIME_VER17% %SDK_VER% -vcvars_ver=14.11.25503
@IF "%CMAKE_SYSTEM_PROCESSOR%"=="amd64" call %VSVARS% %VS_TARGET_AMD64% %RUNTIME_VER17% %SDK_VER% -vcvars_ver=14.11.25503

@IF "%CMAKE_SYSTEM_PROCESSOR%"=="ARM64" @echo call %VSVARS% %VS_TARGET_ARM64% %RUNTIME_VER17% %SDK_VER% -vcvars_ver=14.11.25503
@IF "%CMAKE_SYSTEM_PROCESSOR%"=="ARM64" call %VSVARS% %VS_TARGET_ARM64% %RUNTIME_VER17% %SDK_VER% -vcvars_ver=14.11.25503
@goto setupenv
