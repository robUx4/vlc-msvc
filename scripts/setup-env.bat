...
@set CPPFLAGS   = "%CPPFLAGS% -DWIN32_WINNT=0x603 -DWINAPI_FAMILY=WINAPI_FAMILY_PHONE_APP"
@set CFLAGS        ="%CFLAGS% -DWIN32_WINNT=0x603 -DWINAPI_FAMILY=WINAPI_FAMILY_PHONE_APP"
@set CXXPPFLAGS="%CXXPPFLAGS% -DWIN32_WINNT=0x603 -DWINAPI_FAMILY=WINAPI_FAMILY_PHONE_APP"
