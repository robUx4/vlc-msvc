...
#  undef _LOCAL_FAMILY_OVERRIDE_ws2def
#  if WINAPI_FAMILY == WINAPI_FAMILY_PC_APP
#   define _LOCAL_FAMILY_OVERRIDE_ws2def 1
#  else
#   define _LOCAL_FAMILY_OVERRIDE_ws2def 2
#  endif
#  undef WINAPI_FAMILY
